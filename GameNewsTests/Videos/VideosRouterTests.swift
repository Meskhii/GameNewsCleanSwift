...
final class VideosRouterTests: XCTestCase {
    private var sut: VideosRouter!
    ...
    func testGivenRouterWhenNavigateToPlayVideoThenPresentCalledOnSource() {
        sut.navigateToPlayVideoForSelected(videoId: "")
